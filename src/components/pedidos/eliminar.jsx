...
function PedidoEliminar({ pedido }) {
    ...
    return (
        <div className="flex flex-col gap-4">
            <h1 className="text-2xl text-red-500">¿Desea eliminar los siguentes datos?</h1>
            ...
            <form className="flex flex-col gap-4" action={action} id={formId}>
                ...
                <button className="p-2 rounded-lg bg-red-500 text-white cursor-pointer">Eliminar</button>
            </form>
        </div>
    );
}
