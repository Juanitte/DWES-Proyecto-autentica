...
async function PaginaLogin({ searchParams }) {
  ...
  return (
    <div className="relative mt-8 mx-auto flex flex-col gap-2 w-[375px]">
      ...
      <RegisterForm className="hidden peer-checked/register:block w-full bg-slate-700 mt-10 border-2 border-slate-400 rounded-md mx-auto p-8 " />
      <LoginForm className="hidden peer-checked/login:block w-full bg-slate-700 mt-10 border-2 border-slate-400 rounded-md mx-auto p-8 " />
      <OauthForm className="hidden peer-checked/oauth:block w-full bg-slate-700 mt-10 border-2 border-slate-400 rounded-md mx-auto p-8 " />
